...
class Impfy extends _i1.GeneratedContract {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> invalidateDoctor(
      _i1.EthereumAddress doctor, BigInt blockNumber,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
    final function = self.abi.functions[5];
    assert(checkSignature(function, '30ae3028'));
    final params = [doctor, blockNumber];
    return write(credentials, transaction, function, params);
  }
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> invalidateDoctor$2(_i1.EthereumAddress doctor,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
